...
def gira(lado, velocidade=v_gira, raio=0.7):
    if lado == 'direita' or lado == 'dir':
        m_esq.run_forever(speed_sp=velocidade*raio)
        m_dir.run_forever(speed_sp=velocidade*(1-raio))
    elif lado == 'esquerda'or lado == 'esq':
        m_esq.run_forever(speed_sp=velocidade*(1-raio))
        m_dir.run_forever(speed_sp=velocidade*raio)
