...
def anda_posicao(distancia):
	n_taco = distancia/taco_mm
	n_taco = n_taco*fator_correcao_linear
	m_esq.run_to_rel_pos(position_sp=n_taco, speed_sp=300, stop_action="brake")
	m_dir.run_to_rel_pos(position_sp=n_taco, speed_sp=300, stop_action="brake")
